...
const theme = {
    panel: { width: "360px", background: "#ffffff", borderRight: "1px solid #e5e7eb", display: "flex", flexDirection: "column", height: "100vh", fontFamily: "'Inter', sans-serif", zIndex: 10, boxShadow: "4px 0 24px rgba(0,0,0,0.02)" },
    ...
    // NOUVEAU : Header pour les sliders (Label à gauche, valeur à droite)
    ...
    // NOUVEAU : Style des sliders
    slider: { width: "100%", cursor: "pointer", accentColor: "#111827" },

    input: { width: "100%", padding: "10px 12px", borderRadius: "8px", border: "1px solid #d1d5db", fontSize: "14px", color: "#111827", backgroundColor: "#f9fafb", boxSizing: "border-box", outline: "none" },
    select: { width: "100%", padding: "10px 12px", borderRadius: "8px", border: "1px solid #d1d5db", fontSize: "14px", color: "#111827", backgroundColor: "#f9fafb", cursor: "pointer", boxSizing: "border-box", outline: "none" },
    btnPrimary: { width: "100%", padding: "14px", background: "#111827", color: "#ffffff", border: "none", borderRadius: "8px", fontSize: "14px", fontWeight: "600", cursor: "pointer", display: "block", textAlign: "center", textDecoration: "none", boxSizing: "border-box", boxShadow: "0 4px 6px -1px rgba(0,0,0,0.1)" },
    btnSecondary: { width: "100%", padding: "12px 10px", background: "#ffffff", color: "#111827", border: "1px solid #d1d5db", borderRadius: "8px", fontSize: "13px", fontWeight: "600", cursor: "pointer", display: "flex", justifyContent: "center", alignItems: "center", gap: "8px", boxSizing: "border-box", transition: "all 0.2s", boxShadow: "0 1px 2px rgba(0,0,0,0.05)" },
    colorPickerWrapper: { display: "flex", alignItems: "center", gap: "10px", padding: "8px 12px", borderRadius: "8px", border: "1px solid #d1d5db", background: "#f9fafb" },
    colorPicker: { width: "24px", height: "24px", border: "none", cursor: "pointer", background: "none", padding: 0 },
    checkboxWrapper: { display: "flex", alignItems: "center", gap: "10px", padding: "10px 12px", border: "1px solid #d1d5db", borderRadius: "8px", cursor: "pointer", background: "#f9fafb" },
    checkbox: { width: "16px", height: "16px", accentColor: "#111827", cursor: "pointer", margin: 0 },
    bottomBar: { position: "absolute", bottom: "32px", left: "50%", transform: "translateX(-50%)", backgroundColor: "#ffffff", padding: "20px 32px", borderRadius: "16px", boxShadow: "0 25px 50px -12px rgba(0,0,0,0.25)", display: "flex", gap: "32px", alignItems: "flex-end", zIndex: 100, border: "1px solid #e5e7eb" },
...
export default function DressingConfigurator() {
    ...
    const loadPreset = (type) => {
        if (type === "suite") {
            setLargeurTotaleCM(300); setProfondeurCM(60); setFinitionExt("Chêne"); setFinitionInt("Couleur"); setCouleurInt("#1e293b"); setAvecPoignees(true);
            setConfigs({ 0: 5, 1: 7, 2: 5 }); 
            setHauteurs({ 0: 240, 1: 240, 2: 240 });
        } else if (type === "entree") {
            setLargeurTotaleCM(120); setProfondeurCM(45); setFinitionExt("Couleur"); setCouleurExt("#cbd5e1"); setFinitionInt("Chêne");
            setConfigs({ 0: 5, 1: 4 }); 
            setHauteurs({ 0: 200, 1: 200 });
        } else if (type === "biblio") {
            setLargeurTotaleCM(240); setProfondeurCM(35); setFinitionExt("Chêne"); setFinitionInt("Chêne"); setAvecPoignees(false);
        ...
        <div style={{ display: "flex", width: "100vw", height: "100vh", overflow: "hidden", background: "#f8fafc" }}>
            ...
            <div style={theme.panel}>
                ...
                <div style={theme.scrollArea}>
                    ...
                    <div style={theme.section}>
                        <div style={theme.sectionHeader}><Icons.Star /><h3 style={theme.sectionTitle}>Inspirations</h3></div>
                        <div style={theme.grid2}>
                            <button onClick={() => loadPreset('suite')} style={theme.btnSecondary}>Suite Parentale</button>
                            <button onClick={() => loadPreset('entree')} style={theme.btnSecondary}>Meuble Entrée</button>
                            <button onClick={() => loadPreset('biblio')} style={theme.btnSecondary}>Bibliothèque</button>
                        </div>
                    </div>

                    {/* DIMENSIONS (SLIDERS) */}
                    <div style={theme.section}>
                        <div style={theme.sectionHeader}><Icons.Layout /><h3 style={theme.sectionTitle}>Dimensions Globales</h3></div>
                    ...
                    {/* FINITIONS */}
                    <div style={theme.section}>
                        <div style={theme.sectionHeader}><Icons.Box /><h3 style={theme.sectionTitle}>Finitions du bois</h3></div>
                    ...
                    {/* ACCESSOIRES */}
                    <div style={theme.section}>
                        <div style={theme.sectionHeader}><Icons.Settings /><h3 style={theme.sectionTitle}>Accessoires</h3></div>
                        <div style={theme.inputGroup}>
            ...
            <div style={{ flex: 1, position: "relative" }}>
                ...
                {selectedId !== null && (
                    <div style={theme.bottomBar}>
                        ...
                        <div style={theme.bottomBarSection}>
                            ...
                            <input 
                                type="number" value={hauteurs[selectedId] || 200} min="50" max="250" step="1"
                ...
                <Canvas shadows camera={{ position: [0, 1.5, 4.5], fov: 45 }}>
                    ...
                    <ContactShadows position={[0, -0.005, 0]} opacity={0.65} scale={20} blur={2.5} far={2} resolution={1024} color="#1e293b" />
