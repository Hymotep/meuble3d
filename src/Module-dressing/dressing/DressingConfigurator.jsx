...
const theme = {
    panel: {
        width: "360px", background: "#ffffff", borderRight: "1px solid #e5e7eb",
        display: "flex", flexDirection: "column", height: "100vh",
        fontFamily: "'Inter', sans-serif", zIndex: 10, boxShadow: "4px 0 24px rgba(0,0,0,0.02)",
    },
    ...
    input: {
        ...
        fontSize: "14px", color: "#111827", backgroundColor: "#f9fafb", boxSizing: "border-box", outline: "none",
    },
    select: {
        width: "100%", padding: "10px 12px", borderRadius: "8px", border: "1px solid #d1d5db",
        fontSize: "14px", color: "#111827", backgroundColor: "#f9fafb", cursor: "pointer",
        boxSizing: "border-box", outline: "none",
    },
    btnPrimary: {
        width: "100%", padding: "14px", background: "#111827", color: "#ffffff", border: "none",
        borderRadius: "8px", fontSize: "14px", fontWeight: "600", cursor: "pointer",
        display: "block", textAlign: "center", textDecoration: "none", boxSizing: "border-box",
        boxShadow: "0 4px 6px -1px rgba(0,0,0,0.1)",
    },
    btnSecondary: {
        width: "100%", padding: "12px 10px", background: "#ffffff", color: "#111827", border: "1px solid #d1d5db",
        borderRadius: "8px", fontSize: "13px", fontWeight: "600", cursor: "pointer",
        display: "flex", justifyContent: "center", alignItems: "center", gap: "8px",
        boxSizing: "border-box", transition: "all 0.2s", boxShadow: "0 1px 2px rgba(0,0,0,0.05)",
    },
    colorPickerWrapper: {
        display: "flex", alignItems: "center", gap: "10px", padding: "8px 12px",
        borderRadius: "8px", border: "1px solid #d1d5db", background: "#f9fafb",
    },
    colorPicker: { width: "24px", height: "24px", border: "none", cursor: "pointer", background: "none", padding: 0 },
    checkboxWrapper: {
        display: "flex", alignItems: "center", gap: "10px", padding: "10px 12px",
        border: "1px solid #d1d5db", borderRadius: "8px", cursor: "pointer", background: "#f9fafb",
    },
    checkbox: { width: "16px", height: "16px", accentColor: "#111827", cursor: "pointer", margin: 0 },
    bottomBar: {
        position: "absolute", bottom: "32px", left: "50%", transform: "translateX(-50%)",
        backgroundColor: "#ffffff", padding: "20px 32px", borderRadius: "16px",
        boxShadow: "0 25px 50px -12px rgba(0,0,0,0.25)", display: "flex", gap: "32px",
        alignItems: "flex-end", zIndex: 100, border: "1px solid #e5e7eb",
    },
    bottomBarSection: { display: "flex", flexDirection: "column", gap: "10px", borderRight: "1px solid #e5e7eb", paddingRight: "32px" },
};

const Icons = {
    House: () => (<svg width="16" height="16" fill="none" stroke="currentColor" strokeWidth="2"><path d="M3 9l9-7 9 7v11a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z"></path><polyline points="9 22 9 12 15 12 15 22"></polyline></svg>),
    Star: () => (<svg width="16" height="16" fill="none" stroke="currentColor" strokeWidth="2"><polygon points="12 2 15.09 8.26 22 9.27 17 14.14 18.18 21.02 12 17.77 5.82 21.02 7 14.14 2 9.27 8.91 8.26 12 2"></polygon></svg>),
    Layout: () => (<svg width="16" height="16" fill="none" stroke="currentColor" strokeWidth="2"><rect x="3" y="3" width="18" height="18" rx="2"></rect></svg>),
    Box: () => (<svg width="16" height="16" fill="none" stroke="currentColor" strokeWidth="2"><path d="M21 16V8a2 2 0 0 0-1-1.73l-7-4a2 2 0 0 0-2 0l-7 4A2 2 0 0 0 3 8v8a2 2 0 0 0 1 1.73l7 4a2 2 0 0 0 2 0l7-4A2 2 0 0 0 21 16z"></path></svg>),
    Settings: () => (<svg width="16" height="16" fill="none" stroke="currentColor" strokeWidth="2"><circle cx="12" cy="12" r="3"></circle><path d="M19.4 15a1.65 1.65 0 0 0 .33 1.82l.06.06a2 2 0 0 1 0 2.83 2 2 0 0 1-2.83 0l-.06-.06a1.65 1.65 0 0 0-1.82-.33 1.65 1.65 0 0 0-1 1.51V21a2 2 0 0 1-2 2 2 2 0 0 1-2-2v-.09A1.65 1.65 0 0 0 9 19.4a1.65 1.65 0 0 0-1.82.33l-.06.06a2 2 0 0 1 0-2.83 2 2 0 0 1 2.83 0l.06.06a1.65 1.65 0 0 0 .33-1.82 1.65 1.65 0 0 0-1.51-1H3a2 2 0 0 1-2-2 2 2 0 0 1 2-2h.09A1.65 1.65 0 0 0 4.6 9a1.65 1.65 0 0 0-.33-1.82l-.06-.06a2 2 0 0 1 0-2.83 2 2 0 0 1 2.83 0l.06.06a1.65 1.65 0 0 0 1.82.33H9a1.65 1.65 0 0 0 1-1.51V3a2 2 0 0 1 2-2 2 2 0 0 1 2 2v.09a1.65 1.65 0 0 0 1 1.51 1.65 1.65 0 0 0 1.82-.33l.06-.06a2 2 0 0 1 2.83 0 2 2 0 0 1 0 2.83l-.06.06a1.65 1.65 0 0 0-.33 1.82V9a1.65 1.65 0 0 0 1.51 1H21a2 2 0 0 1 2 2 2 2 0 0 1-2 2h-.09a1.65 1.65 0 0 0-1.51 1z"></path></svg>),
};

// ============================================================================
// --- NOUVEAU COMPOSANT : CAMERAMAN INTELLIGENT (CORRIGÉ) ---
// ============================================================================
const AutoFitCamera = ({ largeurTotaleCM, hauteurs }) => {
    ...
    useEffect(() => {
        ...
        // La caméra vise le centre de la hauteur du meuble
        const centerHeight = maxHMeters / 2;
        controls.target.set(0, centerHeight, 0);

        // Calcul du recul nécessaire en fonction de la taille de l'écran
        ...
        // On recule la caméra avec BEAUCOUP plus de marge (+3.0m)
        const idealDistance = Math.max(fitHeightDistance, fitWidthDistance) + 3.0;

        // Astuce magique : On utilise des coordonnées sphériques.
        // Cela permet d'éloigner la caméra SANS annuler l'angle de vue que le client a choisi !
        const spherical = new THREE.Spherical().setFromVector3(
            camera.position.clone().sub(controls.target)
        );
        spherical.radius = idealDistance;
        
        // Application de la nouvelle distance
        camera.position.setFromSpherical(spherical).add(controls.target);
        controls.update();

    }, [largeurTotaleCM, hauteurs, camera, controls]);

    return null;
};

// ============================================================================
// --- COMPOSANT : LA PIÈCE (MURS INFINIS) ---
// ============================================================================
const RoomContext = ({ couleurMur, couleurSol, profondeurCM }) => {
    const zMur = -(profondeurCM / 100);

    return (
        <group position={[0, -0.01, 0]}>
            {/* SOL ÉNORME POUR POUVOIR TOURNER AUTOUR */}
...
export default function DressingConfigurator() {
    ...
    const loadPreset = (type) => {
        if (type === "suite") {
            setLargeurTotaleCM(300); setProfondeurCM(60); setFinitionExt("Chêne"); setFinitionInt("Couleur"); setCouleurInt("#1e293b"); setAvecPoignees(true); setAvecLED(true);
            setConfigs({ 0: 5, 1: 7, 2: 5 });
            setHauteurs({ 0: 240, 1: 240, 2: 240 });
            setCouleurMur("#1e293b"); setCouleurSol("#3f3f46"); 
        } else if (type === "entree") {
            setLargeurTotaleCM(120); setProfondeurCM(45); setFinitionExt("Couleur"); setCouleurExt("#cbd5e1"); setFinitionInt("Chêne"); setAvecLED(false);
            setConfigs({ 0: 5, 1: 4 });
            setHauteurs({ 0: 200, 1: 200 });
            setCouleurMur("#ffffff"); setCouleurSol("#d1d5db"); 
        } else if (type === "biblio") {
            setLargeurTotaleCM(240); setProfondeurCM(35); setFinitionExt("Chêne"); setFinitionInt("Chêne"); setAvecPoignees(false); setAvecLED(true);
            setConfigs({ 0: 2, 1: 2, 2: 2, 3: 2, 4: 2 });
            setHauteurs({ 0: 220, 1: 220, 2: 220, 3: 220, 4: 220 });
            setCouleurMur("#f1f5f9"); setCouleurSol("#fef3c7"); 
        }
        setSelectedId(null);
    };
        ...
        <div style={{ display: "flex", width: "100vw", height: "100vh", overflow: "hidden", background: "#f8fafc" }}>
            ...
            <div style={theme.panel}>
                ...
                <div style={theme.scrollArea}>
                    <Link to="/cuisine" style={theme.btnPrimary}>
                        ➔ Cuisines 3D
                    </Link>
                    ...
                    <div style={theme.section}>
                        <div style={theme.sectionHeader}><Icons.House /><h3 style={theme.sectionTitle}>🏠 Votre pièce</h3></div>
                        
                        <div style={theme.grid2}>
                            <div style={theme.inputGroup}>
                                <label style={theme.label}>Couleur du mur</label>
                                <div style={theme.colorPickerWrapper}>
                                    <input type="color" value={couleurMur} onChange={(e) => setCouleurMur(e.target.value)} style={{...theme.colorPicker, width: "100%"}} />
                                </div>
                            </div>
                            ...
                            <div style={theme.inputGroup}>
                                ...
                                <div style={theme.colorPickerWrapper}>
                                    <input type="color" value={couleurSol} onChange={(e) => setCouleurSol(e.target.value)} style={{...theme.colorPicker, width: "100%"}} />
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div style={{ flex: 1, position: "relative" }}>
                ...
                {selectedId !== null && (
                    <div style={theme.bottomBar}>
                        ...
                        <div style={theme.bottomBarSection}>
                            <label style={theme.sectionTitle}>Hauteur (cm)</label>
                            <input
                                type="number"
                ...
                <Canvas shadows camera={{ position: [0, 1.5, 5], fov: 45 }}>
                    <AutoFitCamera largeurTotaleCM={largeurTotaleCM} hauteurs={hauteurs} />
                    ...
                    {/* PLUS DE LIMITE DROITE/GAUCHE (Azimuth) ! Tourne autant que tu veux. */}
                    <OrbitControls 
                        makeDefault 
                        minPolarAngle={Math.PI / 8} // T'empêche juste de voir depuis le plafond
                        maxPolarAngle={Math.PI / 2 - 0.05} // T'empêche d'aller SOUS le sol
                        enableDamping 
                        dampingFactor={0.05} 
                    />
                </Canvas>
